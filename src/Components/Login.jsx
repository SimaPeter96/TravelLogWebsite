    ...
    <div className="w-screen h-screen flex">
      <div className="w-1/2 relative">
        ...
        <div className="absolute top-0 left-0 right-0 text-left mt-10 ml-10">
          <div className='title'>
          <span className="text-4xl absolute top-0 left-0 right-0 mt-10 ml-10 font-bold text-blue text-center mix-blend-overlay font-poppins">
            MOTHER CITY TOURS
          </span>
          </div>
          ...
          <div className='py-6'>
            ...
            <span className='mr-6 w-full text-md font-bold text-gray-600'>Email</span>
            </div>
            <input
              type='text'
              ...
              name='email'
              id='email'
              style={{ width: 'calc(100% - 15rem)' }} // Adjust placeholder width
            />
          </div>
          <div className='py-2'>
        ...
        <button className='w-full bg-white border-white shadow-lg text-md p-2 rounded-lg flex items-center justify-center'  style={{ width: 'calc(100% - 15rem)' }}>
